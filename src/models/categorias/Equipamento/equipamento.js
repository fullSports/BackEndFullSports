...
const equipamentoSchema = new mongoose_1.default.Schema({
    id: {
        type: String
    },
    nome: {
...
const equipamento = mongoose_1.default.model("equipamentos", equipamentoSchema);
exports.default = equipamento;
