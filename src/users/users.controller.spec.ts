...
describe("UserController", () => {
  ...
  it("• run the method SearchUserById()", async () => {
    ...
    expect(searchUserById.login.password == registeredCustomer.login.password);
    expect(searchUserById.dataNascimento == registeredCustomer.dataNascimento);
  ...
  it("• run the method UpdateUserById()", async () => {
    ...
    expect(UpdateUser.user.login.password == registeredCustomer.login.password);
